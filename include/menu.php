                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            if(!empty($data['logo'])){
                                ...
                                echo '<img class="logoside" src="./asset/img/lg2.jpg"/>';
                            }
                            if(!empty($data['nama'])){
                                echo '<h5 class="smk-side">'.$data['nama'].'</h5>';
                            } else {
                                echo '<h5 class="smk-side">Persmekenjo</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Jalan Dokter Sutomo No. 15, Sengon, Kec. Jombang, Kabupaten Jombang</p>';
                            }
                        }
                    ?>
                </div>
